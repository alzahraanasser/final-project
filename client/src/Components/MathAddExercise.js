...
function MathAddExercise() {
    ...
    if (option === question.correct) {
      ...
      if (!hasAwarded) {
        ...
        await axios.post(
          ...
          { pointsToAdd: 1, activityId: 'math-add-1' },
        ...
        await axios.post(
          "http://localhost:5000/activity-answers",
          {
            ...
            activityId: 'math-add-1',
            activityType: 'math-add',
  ...
  return (
    <Container className="mt-5 text-center">
      ...
      <h2 className="text-primary mb-4">➕ تمرين الجمع</h2>
...
export default MathAddExercise;