...
function MathSubtractExercise() {
    ...
    if (answer === 3) {
      ...
      if (!hasAwarded) {
        ...
        await axios.post(
          ...
          { pointsToAdd: 1, activityId: 'math-subtract-1' },
        ...
        await axios.post(
          "http://localhost:5000/activity-answers",
          {
            ...
            activityId: 'math-subtract-1',
            activityType: 'math-subtract',
  ...
  const handleSpeak = () => {
    const utterance = new SpeechSynthesisUtterance("٥ ناقص ٢ يساوي كم؟");
  ...
  return (
    <Container className="mt-5 text-center">
      ...
      <h2 className="text-danger mb-4">➖ تمرين الطرح</h2>
      <Card className="shadow p-4">
        <CardBody>
          <h4 className="mb-3">٥ - ٢ = ؟</h4>
...
export default MathSubtractExercise;
